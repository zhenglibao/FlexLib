 ...
 */
@property(nonatomic,assign) NSEdgeInsets safeArea;
@property(nonatomic,copy) NSEdgeInsets (^calcSafeArea)(void);

/**
 * 获取xml中的顶级窗口
 */
@property(nonatomic,readonly) NSView* topSubView;
